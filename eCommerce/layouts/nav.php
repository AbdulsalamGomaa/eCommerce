...
$categorySelectResult = $categoryObject->read();
                ...
                <div class="col-lg-9 col-md-8 col-6">
                    <div class="header-bottom-right">
                                ...
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">Categories</a>
                                        <ul class="mega-menu">
                                            ...
                                            <!-- loop on categories -->
                                            <?php 
                                                if($categorySelectResult) {
                                                    $categories = $categorySelectResult->fetchAll(PDO::FETCH_ASSOC);
                        ...
                        <div class="header-currency">
                            ...
                            <span
                                class="digit"><?= $_SESSION['user']->first_name ." ". $_SESSION['user']->last_name ?>
